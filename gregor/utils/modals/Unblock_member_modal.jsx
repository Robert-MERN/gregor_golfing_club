        ...
        >
            <div className=' md:w-[500px] p-6 md:p-7 relative flex flex-col gap-8 md:gap-10' >
                ...
                <div className='w-full flex justify-end gap-4' >
                    ...
                    <button onClick={handle_unblock} className='bg-[#6CBE45]hover:opacity[.8] px-4 py-[6px] rounded-md text-white text-[12px] md:text-[15px] transition-all' >Unblock</button>
                </div>
            </div>
        </Dialog>
    )
